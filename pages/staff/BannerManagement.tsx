  ...
  const handleCreateBanner = async () => {
    const { value: formValues } = await Swal.fire({
      ...
      html: `
        <div class="space-y-4 text-left">
          <div class="space-y-1.5">
            <label class="text-[10px] font-black text-black uppercase ml-2 tracking-wider">Tiêu đề Banner</label>
          ...
          <div class="space-y-1.5">
            <label class="text-[10px] font-black text-black uppercase ml-2 tracking-wider">Hình ảnh (Bắt buộc)</label>
          ...
          <div class="grid grid-cols-2 gap-4">
            <div class="space-y-1.5">
              <label class="text-[10px] font-black text-black uppercase ml-2 tracking-wider">Loại liên kết</label>
            ...
            <div class="space-y-1.5">
              <label class="text-[10px] font-black text-black uppercase ml-2 tracking-wider">ID mục tiêu (Tùy chọn)</label>
          ...
          <div class="space-y-1.5">
            <label class="text-[10px] font-black text-black uppercase ml-2 tracking-wider">Đường dẫn thủ công (Tùy chọn)</label>
          ...
          <div class="grid grid-cols-2 gap-4">
            <div class="space-y-1.5">
              <label class="text-[10px] font-black text-black uppercase ml-2 tracking-wider">Vị trí (Số dương)</label>
          ...
          <div class="grid grid-cols-2 gap-4">
            <div class="space-y-1.5">
              <label class="text-[10px] font-black text-black uppercase ml-2 tracking-wider">Ngày bắt đầu</label>
            ...
            <div class="space-y-1.5">
              <label class="text-[10px] font-black text-black uppercase ml-2 tracking-wider">Ngày kết thúc</label>
      ...
      customClass: {
        ...
        cancelButton: 'rounded-2xl font-black uppercase tracking-widest text-xs px-10 py-5 text-black hover:bg-slate-50 transition-all'
      },
      preConfirm: () => {
    ...
    const { value: formValues } = await Swal.fire({
      ...
      html: `
        <div class="space-y-4 text-left">
          ...
          <div class="space-y-1.5">
            <label class="text-[10px] font-black text-black uppercase ml-2 tracking-wider">Thay đổi hình ảnh (Để trống nếu giữ cũ)</label>
            <input id="swal-image" type="file" accept="image/*" class="w-full px-5 py-4 rounded-2xl bg-slate-50 border-2 border-transparent focus:border-primary/30 focus:bg-white outline-none transition-all text-sm font-bold text-slate-700 shadow-sm">
          </div>
          ...
          <div class="space-y-1.5">
            <label class="text-[10px] font-black text-black uppercase ml-2 tracking-wider">Đường dẫn thủ công</label>
          ...
          <div class="grid grid-cols-2 gap-4">
            <div class="space-y-1.5">
              <label class="text-[10px] font-black text-black uppercase ml-2 tracking-wider">Vị trí</label>
            ...
            <div class="space-y-1.5">
              <label class="text-[10px] font-black text-black uppercase ml-2 tracking-wider">Trạng thái</label>
    ...
    <div className="bg-white rounded-[2rem] border border-gold/10 shadow-sm overflow-hidden">
      <div className="p-8 border-b border-gold/10 flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-black mt-1">Quản lý các biểu ngữ quảng bá trên trang chủ</p>
        </div>
        <button
      ...
      <div className="p-8">
        {loading ? (
          ...
          <div className="py-20 text-center bg-ritual-bg/30 rounded-3xl border border-dashed border-gold/20 flex flex-col items-center">
            ...
            <p className="text-black font-medium text-lg">Hệ thống chưa có banner nào.</p>
            <p className="text-black text-sm mt-2">Bắt đầu tạo banner đầu tiên để hiển thị trên trang chủ.</p>
          </div>
        ) : (
              ...
              >
                ...
                <div className="p-4 flex-1 flex flex-col">
                  ...
                  <div className="mt-auto pt-4 border-t border-gold/5 grid grid-cols-2 gap-2">
                    <div>
                      <p className="text-[9px] font-black text-black uppercase tracking-widest mb-0.5">Bắt đầu</p>
                      <p className="text-xs font-bold text-slate-700">{new Date(banner.startDate).toLocaleDateString('vi-VN')}</p>
                    </div>
                    <div>
                      <p className="text-[9px] font-black text-black uppercase tracking-widest mb-0.5">Kết thúc</p>
